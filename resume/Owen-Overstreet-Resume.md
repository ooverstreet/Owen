...
### Technical Analyst / Senior Business Analyst | Feb 2022 – Present
*ICE Mortgage Technology (formerly Black Knight Inc.)*
...
- Dedicated support for Wells Fargo on LoanSphere BK/FC/FCR/IM and MSP mappings — mortgage servicing data for foreclosure, bankruptcy, and invoice management.
- Gathered client requirements and implemented configuration and data-mapping changes across six environments (DEV, QA, UAT, PA, PROD); verified data landed in the correct environment before release.
- Wrote T-SQL mapping scripts (insert/update/delete), attorney updates, and zip-code data changes; submitted to DBAs and tracked execution through all environments.
...
- Supported The Goodyear Tire & Rubber Co. Point of Sale incentive program across the U.S. and Canada; worked with POS vendors and Goodyear to get customer data into the application.
- Produced ad-hoc T-SQL reports for Goodyear and their customers; loaded data into SQL Server and ran stored procedures to add or remove records.
- Monitored daily data-load jobs and SSIS tasks; used T-SQL to troubleshoot failures, correct data-quality issues, and confirm loads completed.

### Lead Support Developer / Analytical Development — LoanSphere | March 2008 – Feb 2011
...
- Microsoft Certified Professional (MCP) — May 2000 · A+ — Feb 2006 · Network+ — April 2006
